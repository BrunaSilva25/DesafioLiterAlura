package br.com.bruna.literalura.menu;

import br.com.bruna.literalura.model.Author;
import br.com.bruna.literalura.repository.AuthorRepository;
import br.com.bruna.literalura.repository.BookRepository;
import br.com.bruna.literalura.service.api.GutendexAPIService;
import br.com.bruna.literalura.service.api.IBookAPI;
import br.com.bruna.literalura.service.api.dto.BookData;
import br.com.bruna.literalura.model.Book;
...
public class Menu {
    ...
    public void run() {
        while (true) {
            show("Bem vindo ao LiterAlura");
            show("Escolha uma opção");

            show("1 - Buscar por nome do livro");
            show("2 - Buscar por autor");
            show("3 - Buscar todo histórico de livros no banco ");
            show("4 - Buscar todo histórico por idioma no banco ");
            show("5 - Buscar todo histórico por autor no banco ");
